...
<nav class="navbar navbar-default" id="nav">
  <div class="navbar-header">
    ...
    <a class="navbar-brand clickable">
      <span class="hidden-xs">STI Drive</span>
    </a>
  </div>
  <div class="collapse navbar-collapse" id="nav-buttons">
    <ul class="nav navbar-nav navbar-right">
      <li>
        <a class="" id="thumbnail-display" href="{{ route('logout') }}" onclick="event.preventDefault();
...
{{$totalSize}}
  ...
  {{--<script>--}}
    {{--{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/js/script.js')) !!}</script>--}}
  ...
  <script>
    ...
    Dropzone.options.uploadForm = {
      ...
      init: function() {
        ...
        this.on('success', function(file, response) {
          if (response == 'OK') {
            ...
            console.log(this.defaultOptions.error(file, response.join('\n')));
          }
      });
      },
      ...
      acceptedFiles: ".png,.jpg,.jpeg,.pdf,.docx,.zip,.mp4", //allowed file types, .pdf or anyother would throw error
